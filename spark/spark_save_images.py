...
#    if image_count>internal_params[1]:
      ...
      #  print("You have over "+str(internal_params[1])+" images to process, saving .avro to s3")
    ...
    if image_count>internal_params[0]:
        ...
        print("You have between "+str(internal_params[0])+" and "+str(internal_params[1])+" images to process, saving individual images to s3")
        ...
        print("You have less than "+str(internal_params[0])+" images to process, zipping up everything and saving to s3")
